...
> **DAF: Detecting Diffusion-Generated Images via Dynamic Assembly Forests**
> 
> 📄 [Paper Link (arXiv)]([[2604.09106] Detecting Diffusion-generated Images via Dynamic Assembly ForestsDetecting Diffusion-generated Images via Dynamic Assembly Forests](https://arxiv.org/abs/2604.09106))
...
```
@article{daf2026,
  title={DAF: Detecting Diffusion-Generated Images via Dynamic Assembly Forests},
  author={Mengxin Fu, Yuezun Li},
  journal={arXiv preprint arXiv:2604.09106},
  year={2026}
}
```
